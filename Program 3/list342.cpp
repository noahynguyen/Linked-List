...
int main()
{
    ...
    List342<string> buildlist;
    buildlist.BuildList("int.txt");
    cout << "BUILD LIST: " << buildlist << endl;

    List342<string> secondbuildlist;
    secondbuildlist = buildlist;
    cout << "SECOND BUILD LIST: " << secondbuildlist << endl;

    List342<Child> copyclass1(class1);
    cout << "COPY NUMS: " << copyclass1 << endl;
    return 0; 
