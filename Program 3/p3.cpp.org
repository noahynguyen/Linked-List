...
namespace program3
{
	...
	public:
		...
		TEST_METHOD(insertEndOfthelist_2)
		{
			...
			stream << class1;
			Assert::AreEqual((std::string)"PradnyaAgarwal8AnnKang7JohnZorn4", stream.str());
			score = score + 4;
		...
		TEST_METHOD(insertDuplicates_3)
		{
			...
			ostringstream stream;
			stream << class1;
			Assert::AreEqual((std::string)"PradnyaAgarwal8AnnKang7", stream.str());
			score = score + 4;
		}
		...
		TEST_METHOD(RemoveFirstElement_6)
		{
			...
			stream << *class1;
			stream1 << *class2;
			Assert::AreEqual((std::string)"PradnyaAgarwal8", stream1.str());
			Assert::AreEqual((std::string)"AnnKang7BillVollmann13", stream.str());
			score = score + 4;
		}
		...
		TEST_METHOD(peekFirstSecondLast_7)
		{
			...
			class1->Insert(&c1);
			class1->Peek(c2, temp);
			Assert::AreEqual(temp.name(), string("PradnyaAgarwal"));
			Assert::AreEqual(temp.age(), 8);
			class1->Peek(c1, temp);
			Assert::AreEqual(temp.name(), string("AnnKang"));
			Assert::AreEqual(temp.age(), 7);
			class1->Peek(c3, temp);
			Assert::AreEqual(temp.name(), string("BillVollmann"));
			Assert::AreEqual(temp.age(), 13);
			score = score + 4;
		}
...

		{
			...
			ostringstream stream;
			stream << *class2;
			Assert::AreEqual((std::string)"AnnKang7", stream.str());
		...
		TEST_METHOD(deepcopy_27)
		{
			...
			class2 = class1;
			class1.DeleteList();
			Assert::IsTrue(class2.Peek(c8, temp));
			Assert::IsTrue(class2.Peek(c9, temp));
			score = score + 4;
		}
